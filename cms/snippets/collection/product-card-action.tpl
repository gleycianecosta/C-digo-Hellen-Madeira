...
<a href="javascript:void(0)" onclick="closeFancybox();" title="{{product.name|raw}}" class="flex product-link h-100 w-100 position-relative" align-items="center" justify-space="between" direction="{{card_direction}}" data-fancybox data-type="ajax" data-src="{{url("product",{"pid":product.id,"quickview":true})}}">

  ...
  <div class="newsletter foot-content flex" justify-content="space-between">
    <div class="newsletter-title flex" align-items="center">
      <div class="news-icon">
        <a href="/" target="_blank">
          <img src="https://thumbs2.imgbox.com/59/e7/L5Ob83s9_t.png" alt="image host"/>
        </a>
      </div>
    ...
    <div class="newsletter-form flex" align-items="center">
      <form action="/cadastro_newsletter.php" class="newsletter-form flex" align-items="center" justify-content="center" id="newsletter" method="post" name="newsletter" onsubmit="return newsletterRegister();">
        <input class="newsletter-input" id="newsletter_name" name="newsletter_name" placeholder="Informe seu nome" type="text"/>
        <input class="newsletter-input" id="newsletter_email" name="newsletter_email" placeholder="Informe seu e-mail" type="text"/>
...
<style>
  ...
  .message.news-erro, .message.news-sucesso {
    z-index: 9;
  }
      ...
      $.ajax({
        ...
        success: function (e) {
          $(".newsletter #newsletter .message").remove(),
            ...
            '<div class="message news-erro btn danger flex w-100 position-absolute" justify-content="center" align-items="center">Verifique seu e-mail</div>'
          ),
               setTimeout(function () {
            $(".footer-newsletter .danger").fadeOut("slow");
          }
                          , 2e3))
          : ($(".newsletter #newsletter .registered-successfully").prepend(
